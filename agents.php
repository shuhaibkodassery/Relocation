...
<div class="row">
  <div class="col-lg-8  col-lg-offset-2 col-sm-12">
      <!-- agents -->
      <div class="row">
        <div class="col-lg-2 col-sm-2 "><a href="#"><img src="images/agents/ameen_profile.jpg" class="img-responsive"  alt="agent name"></a></div>
        ...
        <span class="glyphicon glyphicon-earphone"></span>+91 97460 07159</div>
      </div>
      <!-- agents -->
